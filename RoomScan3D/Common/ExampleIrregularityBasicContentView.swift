...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        textColor = UIColor.init(rgb: 0x8C8C8C)
        highlightTextColor = UIColor.init(rgb: 0x196CAC)
        iconColor =  UIColor.init(rgb: 0x8C8C8C)
        highlightIconColor = UIColor.init(rgb: 0x196CAC)
    }
...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.backgroundColor = UIColor.init(rgb: 0x8C8C8C)
    ...
    public override func selectAnimation(animated: Bool, completion: (() -> ())?) {
        ...
        view.backgroundColor = UIColor.init(rgb: 0x196CAC)
        self.addSubview(view)
        playMaskAnimation(animateView: view, target: self.imageView, completion: {
            [weak view] in
            self.imageView.backgroundColor = self.selected ? UIColor.init(rgb: 0x196CAC) : UIColor.init(rgb: 0x8C8C8C)
